...
import {ArrowButton, BackButton, MainButton,} from "../../components/Buttons/Buttons";
                    ...
                    <div className="flex first">
                        ...
                        <div className="spabox flex centered" data-aos="fade-up">
                            <div className="inner_box">
                                ...
                                <div className="playfair">{services[0].title}</div>
                                <p dangerouslySetInnerHTML={{__html: services[0].description}}>
                                </p>
                                <MainButton link={route('client.service.show', services[0].id)} dark text="learn more"/>
                            </div>
                        </div>
                        }
                        {services.length > 1 &&
                        ...
                        <div className="side_boxes">
                            {services.map((service) => {
                                ...
                                return (
                                    <div className="sidebox sb1 flex" style={{ background: `url(${service.main_file_1 ? "/"+service.main_file_1.path+"/"+service.main_file_1.title : "/img/services/2.png"})` }} data-aos="flip-right">
                                        <div className="service_title">
                                            <img src="/img/icons/home/coffee-cup.svg" alt="" className="icon"/>
                                            <div>Café / Restaurant</div>
                                        </div>
                                        <MainButton link={route('client.service.show', service.id)} dark text="learn more"/>
